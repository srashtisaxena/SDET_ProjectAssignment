...
public class DeleteContactWithBaseClass extends BaseClass {
	...
	public void deleteContactWithOrgtest() throws Throwable {
		...
		*/
		...
		String alertMsg1= alt1.getText();
		System.out.println("Actual alert msg is :" + alertMsg1);
		...
		System.out.println(deletionMsg1);
